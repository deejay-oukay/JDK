package seminars.s2.lastlection.draw_pic.sprites;

import seminars.s2.lastlection.common.MainCanvas;
import seminars.s2.lastlection.common.Sprite;
...
public class Picture extends Sprite {
    ...
    public Picture(int x, int y){
        ...
        halfWidth = 62;
        try {
            image = ImageIO.read(new File("src/seminars/s2/lastlection/draw_pic/resource/picachu.png"));
        } catch (IOException e) {
